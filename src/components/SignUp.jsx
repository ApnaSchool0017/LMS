          ...
          <div>
            ...
            >
              <div className="w-full space-y-5">
                {/* form caption */}
                <div className="form-caption flex items-end justify-center text-center space-x-2">
                ...
                <div className="form-element flex flex-col">
                  <label className=" w-full lg:w-4/5 block mx-auto">
                    <span className="block text-lg text-gray-800 mr-56">
                      Username
                    </span>
                    <input
                      type="text"
                ...
                <div className="form-element">
                  <label className=" w-full lg:w-4/5 block mx-auto">
                    <span className="block text-lg text-gray-800 mr-44">
                      Confirm Password
                    </span>
                    <div className="relative">
                      <input
